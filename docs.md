...
*   **Urgency Sorting**: Let the AI automatically evaluate your high-priority items so you tackle the most important tasks first without decision fatigue.
...
*   **Interactive Focus Controls**: Instantly Start, Pause, Reset, or Skip between Work Focus and Break modes inside the full-screen view.
*   **Visual Backdrops (Physics-Engine Atmospheres)**:
    *   *Bird Atmosphere*: Renders flying and sitting bird sprites, dynamically moving toward specific coordinates, chirping musical symbols based on active audio.
    *   *Storm Atmosphere*: A customizable weather canvas rendering falling rain droplets, lightning flashes, drifting storm clouds, and rain splashes on the bottom border.

### Practical Uses:
*   **Procrastination Prevention**: Entering full-screen blocks out all distracting tabs, turning the browser into a high-fidelity deep work environment.
*   **Stress & Anxiety Relief**: The circular breathing guide serves as a physical grounding tool to regulate heart rates before a major deadline.
